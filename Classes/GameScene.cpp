...
bool CGameScene::init()
{
	...
	tb->Add(CBrick::Create(CBrick::BrickType::WaterHead), Vec2(14, 7));
	tb->Add(CBrick::Create(CBrick::BrickType::WaterHead), Vec2(15, 7));
	tb->Add(CBrick::Create(CBrick::BrickType::WaterHead), Vec2(16, 7));
	...
	tb->Add(CBrick::Create(CBrick::BrickType::Water), Vec2(14, 8));
	tb->Add(CBrick::Create(CBrick::BrickType::Water), Vec2(15, 8));
	tb->Add(CBrick::Create(CBrick::BrickType::Water), Vec2(16, 8));
	...
	tb->Add(CBrick::Create(CBrick::BrickType::Water), Vec2(14, 9));
	...
	tb->Add(CBrick::Create(CBrick::BrickType::Rope), Vec2(5, 3));
	tb->Add(CBrick::Create(CBrick::BrickType::Rope), Vec2(5, 4));
	tb->Add(CBrick::Create(CBrick::BrickType::Rope), Vec2(5, 5));
	tb->Add(CBrick::Create(CBrick::BrickType::Rope), Vec2(5, 6));
	tb->Add(CBrick::Create(CBrick::BrickType::Rope), Vec2(5, 7));

	tb->Add(CBrick::Create(CBrick::BrickType::Log), Vec2(15, 0));
